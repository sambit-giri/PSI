...
lfi = psi.LFIRE(simulator, distance, y_obs, prior, bounds, sim_out_den=None, n_m=100, n_theta=100, n_grid_out=100, thetas=None)
lfi.run()
...
lfi2 = psi.LFIRE(simulator2, distance2, y_obs, prior2, bounds2, sim_out_den=None, n_m=100, n_theta=100, n_grid_out=100, thetas=None)
lfi2.run()

plt.scatter(lfi2.thetas[:,0], lfi2.thetas[:,1], c=lfi2.posterior)
plt.colorbar()
